...
public class SchJobExecutionHis implements Serializable {
    private Integer id;
    ...
    private Short jobNodePort;

    private Short retrySeq;
    ...
    public Byte getJobServiceName() {
        return jobServiceName;
    }

    public void setJobServiceName(Byte jobServiceName) {
    ...
    public Short getJobNodePort() {
        return jobNodePort;
    }

    public void setJobNodePort(Short jobNodePort) {
    ...
    public void setRetrySeq(Short retrySeq) {
    ...
    public boolean equals(Object that) {
        ...
        SchJobExecutionHis other = (SchJobExecutionHis) that;
